...
//let rv = ffi('int read_voltage(int)');  
...
let ap_config_got=0;
/*
GPIO.set_mode(WF_PIN, GPIO.MODE_INPUT);
GPIO.set_int_handler(WF_PIN, GPIO.INT_EDGE_POS, function(pin) {
   print('WF_PIN', WF_PIN, 'got interrupt');
}, null);
//GPIO.enable_int(WF_PIN);
*/
...
tds_val=ADC.read(ADC_PIN);
print("TDS VAL = ",tds_val);
