 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/fwbuild-volumes/1.23/apps/init_clean/esp8266/build_contexts/build_ctx_393718860/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /mongoose-os/fw/src/mgos_updater_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_mbedtls_config.yaml /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_sys_config.yaml /fwbuild-volumes/1.23/apps/init_clean/esp8266/build_contexts/build_ctx_393718860/build/gen/mos_conf_schema.yml
 */
...
struct mgos_config_dev {
  char *id;
  char *name;
  char *details;
};

struct mgos_config_dev_ap {
  char *ssid;
  char *paswd;
};

struct mgos_config_dev_wifi {
  char *ssid;
  char *paswd;
};
...
struct mgos_config {
  ...
  struct mgos_config_dev dev;
  struct mgos_config_dev_ap dev_ap;
  struct mgos_config_dev_wifi dev_wifi;
};
...
static inline const struct mgos_config_dev *mgos_sys_config_get_dev(void) { return mgos_config_get_dev(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_dev_id(void) { return mgos_config_get_dev_id(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_dev_name(void) { return mgos_config_get_dev_name(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_dev_details(void) { return mgos_config_get_dev_details(&mgos_sys_config); }
static inline const struct mgos_config_dev_ap *mgos_sys_config_get_dev_ap(void) { return mgos_config_get_dev_ap(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_dev_ap_ssid(void) { return mgos_config_get_dev_ap_ssid(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_dev_ap_paswd(void) { return mgos_config_get_dev_ap_paswd(&mgos_sys_config); }
static inline const struct mgos_config_dev_wifi *mgos_sys_config_get_dev_wifi(void) { return mgos_config_get_dev_wifi(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_dev_wifi_ssid(void) { return mgos_config_get_dev_wifi_ssid(&mgos_sys_config); }
static inline const char *mgos_sys_config_get_dev_wifi_paswd(void) { return mgos_config_get_dev_wifi_paswd(&mgos_sys_config); }
...
static inline void mgos_sys_config_set_dev_id(const char *val) { mgos_config_set_dev_id(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dev_name(const char *val) { mgos_config_set_dev_name(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dev_details(const char *val) { mgos_config_set_dev_details(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dev_ap_ssid(const char *val) { mgos_config_set_dev_ap_ssid(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dev_ap_paswd(const char *val) { mgos_config_set_dev_ap_paswd(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dev_wifi_ssid(const char *val) { mgos_config_set_dev_wifi_ssid(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_dev_wifi_paswd(const char *val) { mgos_config_set_dev_wifi_paswd(&mgos_sys_config, val); }
