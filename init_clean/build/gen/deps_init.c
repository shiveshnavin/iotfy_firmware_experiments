...
static const struct lib_descr {
  ...
  // "ota_shadow". deps: [ "aws" "ota-http-client" "shadow" ]
  {
    .title = "ota_shadow",
  ...
  // "js_demo_bundle". deps: [ "adc" "atca" "aws" "ca-bundle" "dash" "dht" "dns-sd" "gcp" "http-server" "i2c" "mjs" "ota-http-client" "ota-http-server" "ota-shadow" "pwm" "rpc-loopback" "rpc-mqtt" "rpc-service-atca" "rpc-service-config" "rpc-service-fs" "rpc-service-gpio" "rpc-service-i2c" "rpc-service-ota" "rpc-service-wifi" "rpc-uart" "sntp" "spi" "vfs-dev-spi-flash" "wifi" ]
  {
